...
const usageString = `
    ...
    Usage: terminal-weather
       ...
       or: terminal-weather units <unit-type>
       or: terminal-weather display <display-type>
       or: terminal-weather format <format-string>
       or: terminal-weather configure
       or: terminal-weather list
       or: terminal-weather uninstall


    Options:
        -h, --help      print this usage page
        -n, --no-cache  invalidate cache when printing weather string  
`;
